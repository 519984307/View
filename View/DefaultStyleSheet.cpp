...
namespace Rt2::View
{
    ...
    void DefaultStyleSheet::get(QString& dest)
    {
...

        {
            ...
            style.backgroundColor(Colors::Emphasis[0]);
            style.end();
...
#else
    // clang-format off
    constexpr uint8_t DefaultStyle[2296] = {
       ...
       0x46,0x32,0x46,0x33,0x32,0x3b,0x7d,0x51,0x53,0x70,0x6c,0x69,0x74,
       ...
       0x68,0x74,0x3a,0x32,0x70,0x78,0x3b,0x7d,
    };
    // clang-format on
    ...
    {
        String str;
        str.assign((const char*)DefaultStyle, 2296);
        dest = Qsu::to(str);
    }
#endif
